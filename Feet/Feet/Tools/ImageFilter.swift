 ...
 */
struct ImageFilter {
  static func filterAction(_ image: UIImage, overColor: UIColor = UIColor.white, alpha: CGFloat = 0.2 ,blurRadius: Double = 0.0) -> UIImage {
    ...
    let overlayColor = overColor.withAlphaComponent(alpha)
